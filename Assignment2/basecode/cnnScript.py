...
def test(dataloader, model, loss_fn, show_example_errors=True, show_confusion_matrix=True):
    size = len(dataloader.dataset)
...
# optimize(10, train_dataloader, model, cost, optimizer)
# test(test_dataloader, model, cost, True, True)
#
# # # We already performed 1 iteration above.
# optimize(2, train_dataloader, model, cost, optimizer)
# test(test_dataloader, model, cost, show_example_errors=False)

# optimize(3, train_dataloader, model, cost, optimizer)
# test(test_dataloader, model, cost, show_example_errors=False)
